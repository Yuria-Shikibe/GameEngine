	...
	struct DrawBase : VERT_POST_PROV_Ty{
		...
		public:
			...
			static void rectOrtho(const float srcx, const float srcy, const float width, const float height, const bool cap = true){
				Line::line(*ProvTy::contextTexture, srcx, srcy, srcx, srcy + height - Line::contextStroke, ProvTy::contextColor,
							   ProvTy::contextColor, cap);
				Line::line(*ProvTy::contextTexture, srcx, srcy + height, srcx + width - Line::contextStroke, srcy + height,
							   ProvTy::contextColor,
							   ProvTy::contextColor, cap);
				Line::line(*ProvTy::contextTexture, srcx + width, srcy + height, srcx + width, srcy + Line::contextStroke,
							   ProvTy::contextColor,
							   ProvTy::contextColor, cap);
				Line::line(*ProvTy::contextTexture, srcx + width, srcy, srcx + Line::contextStroke, srcy, ProvTy::contextColor,
							   ProvTy::contextColor, cap);
			}
		...
		struct Fancy{
			static void select_rectOrtho(const Geom::OrthoRectFloat rect, const float cornerSize = Line::contextStroke, const bool align = true, const float offset = 0.5f){
