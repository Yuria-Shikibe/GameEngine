//
// Created by Matrix on 2024/5/29.
//
...
namespace UI::Icons{
	...
	export Icon freezing_line_column{};
	...
	export void load(Graphic::TextureAtlas& atlas){
		...
		keyboard_backspace_icon_alternative_outline.wrapper = *atlas.find(
			"ui-keyboard_backspace_icon_alternative_outline");
		iconMap.insert_or_assign("keyboard_backspace_icon_alternative_outline"sv,
		...
		freezing_line_column.wrapper = *atlas.find("ui-freezing-line-column");
		iconMap.insert_or_assign("freezing-line-column"sv, freezing_line_column);
