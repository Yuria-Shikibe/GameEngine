...
namespace Graphic {
	...
	void Draw::vert(const Texture* texture, const float x1, const float y1, const float texSrc1, const float texDest1,
	...
	void Draw::vert_monochromeMix(const Texture* texture, const Color cm, const float x1, const float y1,
	...
	void Draw::vert_monochromeAll(const Texture* texture, const Color c, const Color cm, const float x1, const float y1,
